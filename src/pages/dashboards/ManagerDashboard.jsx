    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-surface-primary rounded-2xl border border-border-secondary p-5
          ...
          <h2 className="text-sm font-bold text-text-primary mb-4">Team Absence Summary</h2>
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 rounded-xl bg-amber-500/5 border border-amber-500/10">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-amber-500 flex items-center justify-center text-white text-xs font-bold">2</div>
                <div>
                  <p className="text-sm font-semibold text-text-primary">On Leave Now</p>
                  <p className="text-[10px] text-text-tertiary uppercase">Returning in 2 days</p>
                </div>
              </div>
