            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div className="bg-surface-primary rounded-2xl border border-border-secondary p-5
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-sm font-bold text-text-primary uppercase tracking-tight">Recruitment Pipeline</h2>
                    </div>
                    <MiniChart
                        data={pipeline}
                ...
                <div className="bg-surface-primary rounded-2xl border border-border-secondary p-5
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-sm font-bold text-text-primary uppercase tracking-tight">Employee Attendance</h2>
                    </div>
            ...
            <div className="bg-surface-primary rounded-2xl border border-border-secondary p-5
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-sm font-bold text-text-primary uppercase tracking-tight">Onboarding Progress</h2>
                    </div>
            ...
            <div className="bg-surface-primary rounded-2xl border border-amber-500/20 p-5 animate-fade-in"
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-sm font-bold text-text-primary uppercase tracking-tight">Action Required</h2>
                            <p className="text-[10px] text-text-tertiary font-medium uppercase mt-0.5">Pending Approvals</p>
                        </div>
                    </div>
            ...
            <div className="bg-surface-primary rounded-2xl border border-border-secondary
                ...
                <div className="flex items-center justify-between px-5 pt-5 pb-3">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-sm font-bold text-text-primary uppercase tracking-tight">Leave History & Archive</h2>
                    </div>
