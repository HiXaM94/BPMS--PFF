...
-- ALTER TABLE performances             ENABLE ROW LEVEL SECURITY; -- Table does not exist
ALTER TABLE analytiques              ENABLE ROW LEVEL SECURITY;
ALTER TABLE notifications            ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE ai_agents                ENABLE ROW LEVEL SECURITY; -- Table does not exist
ALTER TABLE ai_recommendations       ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE system_logs              ENABLE ROW LEVEL SECURITY; -- Table does not exist
...
-- Manager can view projects in their entreprise
...
-- ============================================================
-- TABLE: performances (COMMENTED OUT - TABLE DOES NOT EXIST)
-- ADMIN/HR: full CRUD within entreprise
...
-- ============================================================
-- TABLE: ai_agents (COMMENTED OUT - TABLE DOES NOT EXIST)
-- ADMIN: full CRUD
...
CREATE POLICY "ai_recs_manager_select"
  ...
  USING (
    is_manager() AND (
      user_id = auth.uid()
      OR is_my_team_member(employee_id)
    )
  );

-- ============================================================
-- TABLE: system_logs (COMMENTED OUT - TABLE DOES NOT EXIST)
-- ADMIN: full access
-- HR/MANAGER: read within entreprise
-- ============================================================
