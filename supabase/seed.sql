...
-- ============================================================
-- SEED DATA FOR BPMS PLATFORM
-- ============================================================

-- Note: users.id is a FK to auth.users(id).
-- For demo/dev seeding we need to handle this constraint.
-- The constraint will be restored at the end of this seed file.
...
-- PROJECTS
INSERT INTO projects (id,entreprise_id,name,description,status,start_date,end_date,created_by) VALUES
  ('cccccccc-0001-0001-0001-000000000001','11111111-0001-0001-0001-000000000001','BPMS Platform v2.0','Next-generation BPMS platform rebuild','in_progress','2025-10-01','2026-06-30','aaaaaaaa-0001-0001-0001-000000000001'),
  ('cccccccc-0002-0002-0002-000000000002','11111111-0001-0001-0001-000000000001','Q1 Marketing Campaign','Digital marketing campaign for Q1 2026','in_progress','2026-01-01','2026-03-31','aaaaaaaa-0002-0002-0002-000000000002'),
  ('cccccccc-0003-0003-0003-000000000003','11111111-0001-0001-0001-000000000001','API Integration Layer','Backend API integration services','planning','2026-03-01','2026-08-31','aaaaaaaa-0001-0001-0001-000000000001'),
  ('cccccccc-0004-0004-0004-000000000004','11111111-0001-0001-0001-000000000001','QA Automation Suite','Automated testing framework','in_progress','2025-11-01','2026-04-30','aaaaaaaa-0006-0006-0006-000000000006');

-- TASKS
INSERT INTO tasks (id,project_id,assigned_to,created_by,title,description,priority,status,due_date) VALUES
  ('dddddddd-0001-0001-0001-000000000001','cccccccc-0001-0001-0001-000000000001','aaaaaaaa-0003-0003-0003-000000000003','aaaaaaaa-0001-0001-0001-000000000001','Review Q4 Financial Report','Review and validate Q4 financial data','high','in_progress','2026-02-14'),
  ('dddddddd-0002-0002-0002-000000000002','cccccccc-0001-0001-0001-000000000001','aaaaaaaa-0003-0003-0003-000000000003','aaaaaaaa-0001-0001-0001-000000000001','Submit timesheet approval','Weekly timesheet submission','medium','todo','2026-02-15'),
  ('dddddddd-0003-0003-0003-000000000003','cccccccc-0001-0001-0001-000000000001','aaaaaaaa-0003-0003-0003-000000000003','aaaaaaaa-0001-0001-0001-000000000001','Update project documentation','Update all project docs for sprint','low','todo','2026-02-18'),
  ('dddddddd-0004-0004-0004-000000000004','cccccccc-0001-0001-0001-000000000001','aaaaaaaa-0003-0003-0003-000000000003','aaaaaaaa-0001-0001-0001-000000000001','Complete security training','Mandatory security awareness module','high','todo','2026-02-20'),
  ('dddddddd-0005-0005-0005-000000000005','cccccccc-0001-0001-0001-000000000001','aaaaaaaa-0003-0003-0003-000000000003','aaaaaaaa-0001-0001-0001-000000000001','Code review PR #247','Review pull request before merge','medium','in_progress','2026-02-14'),
  ('dddddddd-0006-0006-0006-000000000006','cccccccc-0001-0001-0001-000000000001','aaaaaaaa-0003-0003-0003-000000000003','aaaaaaaa-0001-0001-0001-000000000001','Prepare sprint demo','Prepare demo for sprint review meeting','medium','todo','2026-02-16'),
  ('dddddddd-0007-0007-0007-000000000007','cccccccc-0001-0001-0001-000000000001','aaaaaaaa-0007-0007-0007-000000000007','aaaaaaaa-0001-0001-0001-000000000001','Deploy staging environment','Deploy latest build to staging server','high','completed','2026-02-10'),
  ('dddddddd-0008-0008-0008-000000000008','cccccccc-0001-0001-0001-000000000001','aaaaaaaa-0007-0007-0007-000000000007','aaaaaaaa-0001-0001-0001-000000000001','API Authentication module','Implement JWT auth for REST API','high','in_progress','2026-02-20'),
  ('dddddddd-0009-0009-0009-000000000009','cccccccc-0004-0004-0004-000000000004','aaaaaaaa-0006-0006-0006-000000000006','aaaaaaaa-0006-0006-0006-000000000006','Write E2E test suite','Implement end-to-end tests with Playwright','high','in_progress','2026-03-01'),
  ('dddddddd-0010-0010-0010-000000000010','cccccccc-0002-0002-0002-000000000002','aaaaaaaa-0009-0009-0009-000000000009','aaaaaaaa-0002-0002-0002-000000000002','Design campaign landing page','Create landing page mockups for Q1 campaign','medium','completed','2026-01-25'),
  ('dddddddd-0011-0011-0011-000000000011','cccccccc-0002-0002-0002-000000000002','aaaaaaaa-0002-0002-0002-000000000002','aaaaaaaa-0002-0002-0002-000000000002','Social media content plan','Plan Q1 social media content calendar','medium','in_progress','2026-02-28'),
  ('dddddddd-0012-0012-0012-000000000012','cccccccc-0003-0003-0003-000000000003','aaaaaaaa-0007-0007-0007-000000000007','aaaaaaaa-0001-0001-0001-000000000001','Design API architecture','Design REST API architecture document','high','todo','2026-03-15');

-- PAYROLLS
INSERT INTO payrolls (employee_id,period_start,period_end,salary_base,bonuses,deductions,net_salary,status,created_by) VALUES
  ('bbbbbbbb-0001-0001-0001-000000000001','2026-01-01','2026-01-31',18000,2500,3200,17300,'paid','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0002-0002-0002-000000000002','2026-01-01','2026-01-31',16000,1800,2800,15000,'paid','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0003-0003-0003-000000000003','2026-01-01','2026-01-31',14000,1000,2400,12600,'paid','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0004-0004-0004-000000000004','2026-01-01','2026-01-31',13000, 800,2100,11700,'paid','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0006-0006-0006-000000000006','2026-01-01','2026-01-31',15000,1200,2600,13600,'paid','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0007-0007-0007-000000000007','2026-01-01','2026-01-31',15500,1500,2700,14300,'paid','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0009-0009-0009-000000000009','2026-01-01','2026-01-31',13500, 800,2200,12100,'paid','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0010-0010-0010-000000000010','2026-01-01','2026-01-31',14000,1000,2400,12600,'paid','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0001-0001-0001-000000000001','2026-02-01','2026-02-28',18000,2000,3200,16800,'draft','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0002-0002-0002-000000000002','2026-02-01','2026-02-28',16000,1500,2800,14700,'draft','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0003-0003-0003-000000000003','2026-02-01','2026-02-28',14000, 900,2400,12500,'draft','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0006-0006-0006-000000000006','2026-02-01','2026-02-28',15000,1200,2600,13600,'draft','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0007-0007-0007-000000000007','2026-02-01','2026-02-28',15500,1500,2700,14300,'draft','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0008-0008-0008-000000000008','2026-02-01','2026-02-28',14500,1100,2500,13100,'draft','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0009-0009-0009-000000000009','2026-02-01','2026-02-28',13500, 800,2200,12100,'draft','aaaaaaaa-0004-0004-0004-000000000004'),
  ('bbbbbbbb-0010-0010-0010-000000000010','2026-02-01','2026-02-28',14000,1000,2400,12600,'draft','aaaaaaaa-0004-0004-0004-000000000004');
...
INSERT INTO presences (employee_id,date,check_in_time,check_out_time,hours_worked,overtime_hours,status) VALUES
  ...
  ('bbbbbbbb-0001-0001-0001-000000000001','2026-02-05','08:30','12:00',3.50,0.00,'present'),
...
INSERT INTO leave_balances (employee_id,leave_type,year,total_days,used_days) VALUES
  ('bbbbbbbb-0001-0001-0001-000000000001','annual',2026,22,8),
  ('bbbbbbbb-0001-0001-0001-000000000001','sick',  2026,10,2),
  ('bbbbbbbb-0001-0001-0001-000000000001','remote_work',  2026,24,15),
  ('bbbbbbbb-0001-0001-0001-000000000001','unpaid',2026,10,0),
  ('bbbbbbbb-0002-0002-0002-000000000002','annual',2026,22,5),
  ('bbbbbbbb-0002-0002-0002-000000000002','sick',  2026,10,0),
  ('bbbbbbbb-0002-0002-0002-000000000002','remote_work',  2026,24,8),
  ('bbbbbbbb-0003-0003-0003-000000000003','annual',2026,22,3),
  ('bbbbbbbb-0003-0003-0003-000000000003','sick',  2026,10,1),
  ('bbbbbbbb-0003-0003-0003-000000000003','remote_work',  2026,24,10),
  ('bbbbbbbb-0006-0006-0006-000000000006','annual',2026,22,0),
  ('bbbbbbbb-0006-0006-0006-000000000006','maternity',   2026,90,90),
  ('bbbbbbbb-0007-0007-0007-000000000007','annual',2026,22,2),
  ('bbbbbbbb-0007-0007-0007-000000000007','sick',  2026,10,0),
  ('bbbbbbbb-0009-0009-0009-000000000009','annual',2026,22,4),
  ('bbbbbbbb-0009-0009-0009-000000000009','sick',  2026,10,2),
  ('bbbbbbbb-0010-0010-0010-000000000010','annual',2026,22,1),
  ('bbbbbbbb-0010-0010-0010-000000000010','sick',  2026,10,0);

-- VACANCES (Leave Requests)
INSERT INTO vacances (employee_id,leave_type,start_date,end_date,days_count,reason,status,approved_by,approved_at) VALUES
  ('bbbbbbbb-0001-0001-0001-000000000001','annual','2026-02-20','2026-02-24',5,'Family vacation','pending',NULL,NULL),
  ('bbbbbbbb-0002-0002-0002-000000000002','sick','2026-02-14','2026-02-14',1,'Medical appointment','approved','aaaaaaaa-0004-0004-0004-000000000004','2026-02-13'),
  ('bbbbbbbb-0003-0003-0003-000000000003','annual','2026-03-03','2026-03-07',5,'Personal time off','pending',NULL,NULL),
  ('bbbbbbbb-0006-0006-0006-000000000006','maternity','2026-03-01','2026-05-31',90,'Maternity leave','approved','aaaaaaaa-0004-0004-0004-000000000004','2026-01-15'),
  ('bbbbbbbb-0009-0009-0009-000000000009','annual','2026-02-25','2026-02-26',2,'Moving to new apartment','rejected','aaaaaaaa-0004-0004-0004-000000000004','2026-02-08'),
  ('bbbbbbbb-0007-0007-0007-000000000007','remote_work','2026-02-17','2026-02-21',5,'Remote work week','approved','aaaaaaaa-0004-0004-0004-000000000004','2026-02-10'),
  ('bbbbbbbb-0010-0010-0010-000000000010','annual','2026-03-10','2026-03-12',3,'Short break','pending',NULL,NULL),
  ('bbbbbbbb-0001-0001-0001-000000000001','sick','2026-01-20','2026-01-21',2,'Flu recovery','approved','aaaaaaaa-0004-0004-0004-000000000004','2026-01-19');

-- DOCUMENTS
INSERT INTO documents (employee_id,entreprise_id,title,type,status,uploaded_by,uploaded_at,expires_at) VALUES
  ('bbbbbbbb-0001-0001-0001-000000000001','11111111-0001-0001-0001-000000000001','Employment Certificate','certificate','approved','aaaaaaaa-0001-0001-0001-000000000001','2026-02-01','2027-02-01'),
  ('bbbbbbbb-0003-0003-0003-000000000003','11111111-0001-0001-0001-000000000001','Salary Certificate Jan 2026','certificate','approved','aaaaaaaa-0003-0003-0003-000000000003','2026-02-03','2027-02-03'),
  ('bbbbbbbb-0007-0007-0007-000000000007','11111111-0001-0001-0001-000000000001','Work Experience Letter','other','pending','aaaaaaaa-0007-0007-0007-000000000007','2026-02-10','2027-02-10'),
  ('bbbbbbbb-0009-0009-0009-000000000009','11111111-0001-0001-0001-000000000001','Tax Certificate 2025','other','pending','aaaaaaaa-0009-0009-0009-000000000009','2026-02-12','2027-02-12'),
  ('bbbbbbbb-0002-0002-0002-000000000002','11111111-0001-0001-0001-000000000001','Payslip January 2026','other','approved','aaaaaaaa-0002-0002-0002-000000000002','2026-02-01','2027-02-01'),
  ('bbbbbbbb-0010-0010-0010-000000000010','11111111-0001-0001-0001-000000000001','HR Policy Document','other','pending','aaaaaaaa-0010-0010-0010-000000000010','2026-02-14','2027-02-14'),
  ('bbbbbbbb-0004-0004-0004-000000000004','11111111-0001-0001-0001-000000000001','Employment Certificate','certificate','rejected','aaaaaaaa-0004-0004-0004-000000000004','2026-01-15','2027-01-15');

-- RECRUTEMENTS (Job Postings)
INSERT INTO recrutements (id,entreprise_id,department_id,created_by,title,description,requirements,location,employment_type,salary_min,salary_max,status) VALUES
  ('eeeeeeee-0001-0001-0001-000000000001','11111111-0001-0001-0001-000000000001','22222222-0001-0001-0001-000000000001','aaaaaaaa-0004-0004-0004-000000000004','Senior React Developer',  'Build and maintain React applications',   '5+ years React, TypeScript, REST APIs', 'Casablanca, Morocco','full_time',15000,22000,'open'),
  ('eeeeeeee-0002-0002-0002-000000000002','11111111-0001-0001-0001-000000000001','22222222-0002-0002-0002-000000000002','aaaaaaaa-0004-0004-0004-000000000004','Marketing Specialist',    'Digital marketing campaigns',             '3+ years digital marketing, SEO, SEM',  'Casablanca, Morocco','full_time',10000,14000,'open'),
  ('eeeeeeee-0003-0003-0003-000000000003','11111111-0001-0001-0001-000000000001','22222222-0003-0003-0003-000000000003','aaaaaaaa-0004-0004-0004-000000000004','HR Business Partner',     'Strategic HR management',                 '5+ years HR, HRIS experience',          'Casablanca, Morocco','full_time',12000,16000,'open'),
  ('eeeeeeee-0004-0004-0004-000000000004','11111111-0001-0001-0001-000000000001','22222222-0001-0001-0001-000000000001','aaaaaaaa-0004-0004-0004-000000000004','QA Automation Engineer', 'Automated testing and CI/CD pipelines',   '3+ years QA, automation frameworks',     'Casablanca, Morocco','full_time',12000,16000,'open'),
  ('eeeeeeee-0005-0005-0005-000000000005','11111111-0001-0001-0001-000000000001',NULL,'aaaaaaaa-0004-0004-0004-000000000004','Data Analyst',           'Data analysis and reporting',              '2+ years SQL, Python, Power BI',          'Remote',           'full_time',10000,14000,'open');

-- CANDIDATES
INSERT INTO candidates (recrutement_id,name,email,phone,stage,status,notes,applied_at) VALUES
  ('eeeeeeee-0001-0001-0001-000000000001','Youssef Alami',   'youssef.a@email.com','+212 661 111 222','Technical Interview','interview','Strong portfolio',         '2026-02-01'),
  ...
  ('eeeeeeee-0001-0001-0001-000000000001','Karim Idrissi',   'karim.i@email.com',  '+212 663 333 444','HR Screen',          'screening','Pending technical review', '2026-02-05'),
  ('eeeeeeee-0002-0002-0002-000000000002','Sara Ouali',      'sara.o@email.com',   '+212 664 444 555','Technical Interview','interview','Good campaign experience', '2026-02-03'),
  ('eeeeeeee-0002-0002-0002-000000000002','Mehdi Tazi',      'mehdi.t@email.com',  '+212 665 555 666','HR Screen',          'screening','Needs more B2B experience','2026-02-07'),
  ...
  ('eeeeeeee-0005-0005-0005-000000000005','Zineb Moussaoui', 'zineb.m@email.com',  '+212 668 888 999','HR Screen',          'new','Application under review', '2026-02-14');
...
INSERT INTO analytiques (entreprise_id,report_type,period,period_start,period_end,data,generated_date) VALUES
  ...
  ('11111111-0001-0001-0001-000000000001','hr','February 2026','2026-02-01','2026-02-28','{"open_positions":4,"total_candidates":8,"offers_made":2}','2026-02-15');
...
-- AI AGENTS (table not implemented yet)
...
-- AI RECOMMENDATIONS
INSERT INTO ai_recommendations (user_id,employee_id,type,title,content,confidence,applied) VALUES
  ('aaaaaaaa-0004-0004-0004-000000000004','bbbbbbbb-0003-0003-0003-000000000003','training',
   'Performance Review Recommendation',
   'Task completion rate is 83% — below the 90% target. Enroll Ahmed Hassan in advanced Python training to boost productivity.',
   0.85,false),
  ('aaaaaaaa-0004-0004-0004-000000000004','bbbbbbbb-0007-0007-0007-000000000007','training',
   'Performance Review Recommendation',
   'Code quality is high but documentation scores are consistently low. Pair Bob Tanaka with a senior developer for knowledge transfer sessions.',
   0.80,false),
  ('aaaaaaaa-0004-0004-0004-000000000004','bbbbbbbb-0009-0009-0009-000000000009','leave',
   'Leave Balance Alert',
   'Carlos Ruiz has only used 4 of 22 annual leave days. Encourage planning remaining leave to avoid year-end accumulation.',
   0.90,false),
  ('aaaaaaaa-0004-0004-0004-000000000004',NULL,'candidate',
   'Recruitment Optimization',
   'Nadia Benali scores highest among Senior React Developer applicants. Proceed to offer stage — strong technical test and portfolio review results.',
   0.95,false),
  ('aaaaaaaa-0004-0004-0004-000000000004','bbbbbbbb-0001-0001-0001-000000000001','salary',
   'Performance Bonus Recommendation',
   'Ibrahim Rouass has maintained 90%+ task completion for 2 consecutive quarters. Consider for team lead promotion and performance bonus.',
   0.92,false);

-- SYSTEM LOGS (table not implemented yet)
...
-- FK constraint will be added via separate migration after seeding
-- This allows us to seed mock users without requiring auth.users entries
